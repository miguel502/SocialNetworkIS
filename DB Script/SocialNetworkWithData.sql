...
--
-- Host: localhost
-- Generation Time: Dec 02, 2014 at 03:54 AM
...
INSERT INTO `project` (`id`, `client_id`, `name`, `description`, `active`) VALUES
(1, 6, 'Proyecto de curso', NULL, '1'),
(2, 6, 'GBH', NULL, '1');
